...
describe('applyAssetTypeBehavior', () => {
  it('compounds cash by the monthly-equivalent of cashApy, with no cash flow', () => {
    const cash: Asset = { id: 'c', name: 'Cash', assetType: 'cash', holdingContext: 'none', value: 10000 }
  ...
  it('compounds equity by equityReturn regardless of holdingContext (401k is just equity held in a Traditional Retirement context)', () => {
    const brokerageEquity: Asset = { id: 'e1', name: 'Brokerage', assetType: 'equity', holdingContext: 'taxableBrokerage', value: 50000 }
    const retirementEquity: Asset = { id: 'e2', name: '401(k)', assetType: 'equity', holdingContext: 'traditionalRetirement', value: 50000 }
  ...
  it('produces a distribution cash flow separate from (and not reducing) the equity value', () => {
    const equity: Asset = { id: 'e', name: 'Equity', assetType: 'equity', holdingContext: 'none', value: 100000 }
  ...
  it('appreciates real estate, with no cash flow', () => {
    const home: Asset = { id: 'h', name: 'Home', assetType: 'realEstate', holdingContext: 'none', value: 500000 }
  ...
  it('grows Whole Life cash value via crediting rate + dividend-as-PUA, minus a flat fee — same shape as every other asset', () => {
    const policy: Asset = { id: 'wl', name: 'Whole Life', assetType: 'wholeLifeInsurance', holdingContext: 'none', value: 100000 }
