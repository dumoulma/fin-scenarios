...
// Entirely synthetic — no real account data. Shaped after a real Kubera export we
// inspected while building this importer: multi-currency cash, a brokerage/Roth IRA
// whose ETF holdings appear as separate "child" line items with a `parent` pointer
// back to the account, a whole life policy Kubera files under "Retirement
// Investments" with no dedicated category, a Canadian TFSA with no equivalent in our
// asset model, and a stale $0 duplicate mortgage entry sitting next to the real one.
