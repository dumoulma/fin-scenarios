// Shape confirmed against the live Kubera Data API v3 (`GET /portfolio/<id>`), trimmed
// to the fields the importer actually reads. Real items carry many more fields
// (connection, geography, cagr, ...) that we intentionally ignore.
